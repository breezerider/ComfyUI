...
class ControlNetFlux(Flux):
    ...
    def forward(self, x, timesteps, context, y, guidance=None, hint=None, **kwargs):
        patch_size = 2
        if self.latent_input:
            hint = comfyui.comfy.ldm.common_dit.pad_to_patch_size(hint, (patch_size, patch_size))
        elif self.mistoline:
            hint = hint * 2.0 - 1.0
        ...
        bs, c, h, w = x.shape
        x = comfyui.comfy.ldm.common_dit.pad_to_patch_size(x, (patch_size, patch_size))
