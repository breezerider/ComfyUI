...
from comfyui.comfy.ldm.modules.diffusionmodules.mmdit import (
    Mlp,
    TimestepEmbedder,
    PatchEmbed,
    RMSNorm,
)
from comfyui.comfy.ldm.modules.diffusionmodules.util import timestep_embedding
...
class HunYuanControlNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm = norm
        self.dtype = dtype
        self.latent_format = comfyui.comfy.latent_formats.SDXL
    ...
    def forward(
        ...
        **kwarg,
        ...
        padding = comfyui.comfy.ops.cast_to_input(self.text_embedding_padding, text_states)
