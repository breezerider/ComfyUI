...
class CFGGuider:
    ...
    def inner_set_conds(self, conds):
        for k in conds:
            self.original_conds[k] = comfyui.comfy.sampler_helpers.convert_cond(conds[k])
    ...
    def sample(self, noise, latent_image, sampler, sigmas, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
        ...
        self.inner_model, self.conds, self.loaded_models = comfyui.comfy.sampler_helpers.prepare_sampling(self.model_patcher, noise.shape, self.conds)
        device = self.model_patcher.load_device

        if denoise_mask is not None:
            denoise_mask = comfyui.comfy.sampler_helpers.prepare_mask(denoise_mask, noise.shape, device)
        ...
        comfyui.comfy.sampler_helpers.cleanup_models(self.conds, self.loaded_models)
