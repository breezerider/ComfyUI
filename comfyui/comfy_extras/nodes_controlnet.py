from comfyui.comfy.cldm.control_types import UNION_CONTROLNET_TYPES
...
class ControlNetInpaintingAliMamaApply(comfyui.nodes.ControlNetApplyAdvanced):
    @classmethod
    def INPUT_TYPES(s):
    ...
    def apply_inpaint_controlnet(self, positive, negative, control_net, vae, image, mask, strength, start_percent, end_percent):
        ...
        if control_net.concat_mask:
            ...
            mask_apply = comfyui.comfy.utils.common_upscale(mask, image.shape[2], image.shape[1], "bilinear", "center").round()
