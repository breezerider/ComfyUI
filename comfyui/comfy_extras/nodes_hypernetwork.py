...
def load_hypernetwork_patch(path, strength):
    sd = comfyui.comfy.utils.load_torch_file(path, safe_load=True)
...
class HypernetworkLoader:
    ...
    def INPUT_TYPES(s):
        return {"required": { "model": ("MODEL",),
                              "hypernetwork_name": (comfyui.folder_paths.get_filename_list("hypernetworks"), ),
    ...
    def load_hypernetwork(self, model, hypernetwork_name, strength):
        hypernetwork_path = comfyui.folder_paths.get_full_path_or_raise("hypernetworks", hypernetwork_name)
