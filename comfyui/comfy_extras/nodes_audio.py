...
class LoadAudio:
    ...
    def INPUT_TYPES(s):
        ...
        files = comfyui.folder_paths.filter_files_content_types(os.listdir(input_dir), ["audio", "video"])
    ...
    def load(self, audio):
        audio_path = comfyui.folder_paths.get_annotated_filepath(audio)
    ...
    def IS_CHANGED(s, audio):
        image_path = comfyui.folder_paths.get_annotated_filepath(audio)
        m = hashlib.sha256()
    ...
    def VALIDATE_INPUTS(s, audio):
        if not comfyui.folder_paths.exists_annotated_filepath(audio):
