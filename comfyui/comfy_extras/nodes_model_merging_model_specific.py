...
class ModelMergeSD1(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
...
class ModelMergeSDXL(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD3_2B(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeAuraflow(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeFlux1(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD35_Large(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeMochiPreview(comfyui.comfy_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
